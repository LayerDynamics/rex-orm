...
using the design spec above break the entire development into sprints , be as comprehensive as possible outline each sprints requirements, features and functions they will need, 
