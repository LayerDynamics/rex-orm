...
type ModelConstructor = { new (...args: any[]): any; name: string };
...
export class ModelRegistry {
  private static models: Map<ModelConstructor, ModelMetadata> = new Map();

  static registerModel(model: ModelConstructor) {
